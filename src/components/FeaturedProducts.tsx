    ...
    <section className="py-20 bg-gradient-to-b from-background to-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-5xl lg:text-6xl font-display font-bold text-transparent bg-clip-text bg-gradient-primary mb-4">
            ✨ Featured Products ✨
          </h2>
          <p className="text-2xl text-foreground/80 max-w-2xl mx-auto font-display">
            Top picks that kids absolutely love! 🎈
          </p>
        </div>

        {/* Products grid - Sticker/Game Card Design */}
